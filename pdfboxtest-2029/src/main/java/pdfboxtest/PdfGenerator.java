...
public class PdfGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            generate(new QRTankDownloadTemplate(), new FileOutputStream("out-2029.pdf"), imageInfo);
            generate(new ManifestDownloadTemplate(), new FileOutputStream("out-manifest-2029.pdf"), imageInfo);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void generate(PrintablePDF printablePDF,  OutputStream out, ImageInfo additionalImage) throws IOException {
        ...
        PDDocument a1doc = PDDocument.load(resourceAsStream);
